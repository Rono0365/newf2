//import 'package:Homecare/verifynow/verifyprofile.dart';
import 'package:FreshFit/verifynow/verifynow/verifyprofile.dart';
  ...
  Future<void> scanQR() async {
    ...
    void sendMessage(String h) async {
      ...
      http.Response response = await http.post(
        Uri.parse('https://p2psocketchat.onrender.com/$h'),
        body: {
                  ...
                  child: Column(children: <Widget>[
                    ...
                    Container(
                      ...
                      child: QrImageView(
                        ...
                        embeddedImage: const AssetImage('assets/xon2.png'),
