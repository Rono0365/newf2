...
class regS2 extends StatefulWidget {
  const regS2({Key? key}) : super(key: key);

  @override
  _regS2State createState() => _regS2State();
}

class _regS2State extends State<regS2> {
  ...
  Future createAlbum() async {
    http.Response response1 = await http.post(
      Uri.parse('http://192.168.100.12:7000/register/'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
