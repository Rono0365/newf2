                                                                        ...
                                                                        subtitle:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                                " ",
                                                                                style:
                                                                                    GoogleFonts.lato(color: widget.text1)),
                                                                          ...
                                                                          ? (int.parse(i['points']) *
                                                                                  ...
                                                                                  .toString() 
                                                                              ,style: GoogleFonts.lato(
                                                                                color: widget.xme?Colors.amber.shade200:Colors.amber.shade900
                                                                              ),),
                                                                          ...
                                                                          Text(
                                                                            ...
                                                                            style: GoogleFonts.lato(
                                                                                color: widget.xme
                                                                                    ? Colors.white
                                                                                    : Colors.black,
                                                                                backgroundColor: widget.xme ? Colors.white24 : Colors.orange.shade100),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                      Container(
                                                                      ...
                                                                      InkWell(
                                                                          child: amount3.contains(i)
                                                                              ...
                                                                              : Chip(
                                                                                  ...
                                                                                  label: widget.lang != "Kiswahili (🇰🇪)" ? Text(amount3.contains(i) ? 'Added' : 'Add') : Text(amount3.contains(i) ? 'Umeweka' : 'weka'),
                                                                                  backgroundColor: amount3.contains(i)
                                                                                      ?  !widget.xme ? Colors.grey[200]?.withOpacity(0.4) : Colors.grey[200]?.withOpacity(0.4)
                                                                                      : Colors.white24),
                                                                          onTap: () {
                                                                            //order1
                                                                            //
                                                                          ...
                                                                          amount3.contains(
                                                                              ...
                                                                              : Container(
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                                                                                    Container(
                                                                                      child: InkWell(
                                                                                          child: CircleAvatar(child: const Icon(Icons.add, color: Colors.green), radius: 15, backgroundColor: widget.xme ? Colors.grey[200]?.withOpacity(0.4) : Colors.grey[200]),
                                                                                          onTap: () {
                                                                                            print(i['name']);
                                                                                            setState(() {
                                                                                    ...
                                                                                    const Text('\t'),
                                                                                    Text(ii == i['name'] ? quantity.toString() : '1', style: GoogleFonts.lato(color: widget.text1)),
                                                                                    const Text('\t'),
                                                                                    InkWell(
                                                                                        child: CircleAvatar(child: const Icon(Icons.remove, color: Colors.green), radius: 15, backgroundColor: widget.xme ? Colors.grey[200]?.withOpacity(0.4) : Colors.grey[200]),
                                                                                        onTap: () {
                                                                                          //print(i['name']);
                                                                                          setState(() {
                                                                                            if (quantity > 1) {
