...
//for more info: get me on twitter(now X)@Rono_kenya
void main() {
...
class _MyAppState extends State<MyApp> {
 ...
 // print('Latitude: $latitude, Longitude: $longitude');
  ...
  if (await Permission.location.request() == PermissionStatus.granted) {
    ...
    // Handle permission denied or revoked
    print('Location permission denied or revoked');
  }
}
  ...
  Future getWeather7() async {
    ...
    http.Response responsev = //http://172.16.12.17:8000/
        await http.get(Uri.parse('http://192.168.100.18:8000/chatff/'),
            headers: headers);
  ...
  Future getWeather3x() async {
    ...
    http.Response responsev = //http://172.16.12.17:8000/
        await http.get(Uri.parse('http://192.168.100.18:8000/restaurant/'),
            headers: headers);
  ...
  Future addata(String titlename, String foodster, String otype, String zum,
    ...
    http.Response responsev =
        await http.post(Uri.parse('http://192.168.100.18:8000/orderx/'),
            headers: {
  ...
  Future getWeather(String k) async {
    ...
    http.Response responsev = await http.get(
        Uri.parse('http://192.168.100.18:8000/restaurant/1'),
        headers: headers);
    var results = jsonDecode(responsev.body);
    setState(() {
      this.sky = results;
  ...
  Future getWealth() async {
    ...
    http.Response responsev = await http
        .get(Uri.parse('http://192.168.100.18:8000/orderx/'), headers: headers);
    var xcv = jsonDecode(responsev.body);
    setState(() {
      food1 = xcv;
    });
...
//add message
    http.Response
        ...
        await http.get(Uri.parse('http://192.168.100.18:8000/orderx/'),
            headers: headers);
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => Rutimetable(
            //food1:food1,
            geolocation: "${lat1},${long1},${sky2['username'].toString()}",
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                          ...
                          'Authorization': 'Token ${widget.token}',
                                                                                                                          ...
                                                                                                                          http.Response responsev = await http
                            .get(Uri.parse('http://192.168.100.18:8000/watus/'), headers: headers);
                        var xcv = jsonDecode(responsev.body);
                          ...
                          MaterialPageRoute(
                              builder: (context) => searchQ7(
                                    ...
                                    token: widget.token.toString(),
                                                                                              ...
                                                                                              orderx                                Uri.parse('http://192.168.100.18:8000/chat/'),
